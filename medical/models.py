...
class ExploracionFisica(models.Model):
    ...
    saturacion_oxigeno = models.IntegerField(blank=True, null=True, default=None)
    peso = models.FloatField(blank=True, null=True, default=None)
    talla = models.FloatField(blank=True, null=True, default=None)
    imc = models.FloatField(blank=True, null=True, default=None)
    glucosa = models.FloatField(blank=True, null=True, default=None)
